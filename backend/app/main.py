...
# charts_router (prefix /charts, no /api) es server-to-server: lo llama el
# workflow 04 de n8n directo (http://backend:8000/charts/...) sin cookie de
# sesion de ningun usuario -- exigirla ahi rompe la generacion de graficos.
